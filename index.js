...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@travelgo-cluster.5yple.mongodb.net/travelGoDatabase?retryWrites=true&w=majority`;
...
app.get("/", (req, res) => {
  res.send("Running travelGo Server");
});
...
async function run() {
  try {
    ...
    const database = client.db("travelGoDatabase");
    ...
    app.post("/services", async (req, res) => {
      ...
      console.log("hitted the post services API", insertItem);
